...
class Companies {
  ...
  public function new (
    wg: Domo, model: Model, params: Array<Float>, nicks: Array<String>
  ) {
  ...
  function view () {
    ...
    It.range(n).eachSyn(
      (i, frec) -> {
        ...
        mkChart(i, model, params, nickName, rs -> {
  ...
  static function mkChart (
    iNick: Int, model: Model, params: Array<Float>, nickName: String,
