...
export default class Main {
  ...
  /** @return {!Array<string>} Flea models. */
  get fmodels () {
    if (this._fmodels === null) {
      throw new Error("'models' has not been initialized");
    }
  ...
  async run () {
    ...
    if (page === "_bests") {
      new Bests(self, self._model["lmenu"]).show();
