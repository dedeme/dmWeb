...
static char *app_name = "Fleas2Data";
static char *data_version = "201902";
static char *app_dir = "dmcgi/Fleas2Data";
...
static Js *models_new(void) {
  ...
  EACH(fs, char, f)
    ...
    if (file_is_directory(path) && !str_eq(f, "_bests")) {
