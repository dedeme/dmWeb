...
user_Chpass = class {
  ...
  constructor (up) {
    ...
    /** @private */
    this._captcha = new github_dedeme.Captcha(Main.captchaChpassStore(), 3);
  }
  ...
  changePass (oldPass, newPass) {
    ...
    const data = {
      "page": "changePass",
      "user": client.user(),
      "oldPass": Client.crypPass(oldPass),
  ...
  mk() {
    ...
    function body () {
      ...
      accept.on("click", e => {
        ...
        self.changePass(passv, newPassv);
      });

      cancel.on("click", e => { self.cancel() });
