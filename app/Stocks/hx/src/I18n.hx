...
class I18n {
  ...
  static var enDic = [
    ...
    "Accept" => "Accept",
    "All" => "All",
    "An error is found" => "An error is found",
    ...
    "Stocks number < 1" => "Stocks number < 1",
    "Sum" => "Sum",
    "Summary" => "Summary",
  ...
  static var esDic = [
    ...
    "Accept" => "Aceptar",
    "All" => "Todo",
    "An error is found" => "Hay un error",
    "Annotations" => "Apuntes",
    ...
    "Cash" => "Caja",
    "Cash < 0" => "Caja < 0",
    "Cash is not a valid number" => "Caja no un número válido",
    ...
    "Stocks number < 1" => "Número de acciones < 1",
    "Sum" => "Suma",
    "Summary" => "Resumen",
