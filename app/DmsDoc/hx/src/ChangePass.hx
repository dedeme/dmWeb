...
class ChangePass {
  ...
  public static function mk (wg: Domo, app: String, fn: Void -> Void): Void {
    final oldPass = Ui.pass("newPass").att("id", "autofocus");
    final newPass = Ui.pass("newPass2").att("id", "newPass");
    final newPass2 = Ui.pass("acceptBt").att("id", "newPass2");
