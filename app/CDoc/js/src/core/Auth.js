...
export default class Auth {
  ...
  **/
  show () {
    ...
    const /** !Domo */ userIn = Ui.field("pass").att("id", "userIn");
    const /** !Domo */ pass = Ui.pass("accept").att("id", "pass");
    const /** !Domo */ persistent = $("input")
      .att("type", "checkbox")
      .style("vertical-align: middle");
    const /** !Domo */ accept = $("input")
      .att("type", "button")
      .style("width:90px;")
      .att("id", "accept")
      .value(_("Accept"));
    ...
    **/
    const faccept = async (user, pass, persistent) => {
      ...
      if (ok) captcha.resetCounter();
      else captcha.incCounter();
