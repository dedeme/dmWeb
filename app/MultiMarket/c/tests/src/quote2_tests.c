...
void quote2_tests (void) {
  ...
  push(qs1, "20190208:2.0100:2.0600:3.0000:2.0200:234111:false");
  ...
  push(qs2, "20190208:2.0000:2.0700:3.0000:2.0200:234111:true");
  push(qs2, "20190207:2.0500:2.0700:3.0000:2.0200:234111:false");
  push(qs2, "20190206:2.0000:2.0700:3.0000:2.0200:234111:true");

  qs3 = arr_new();
  push(qs3, "20190215:2.0500:2.0600:3.0000:2.0200:234111:false");
  push(qs3, "20190214:2.0500:2.0600:3.0000:2.0200:234111:false");
  push(qs3, "20190213:2.0100:2.0600:3.0000:2.0200:234111:false");
  push(qs3, "20190212:2.0500:2.0700:3.0000:2.0200:234111:false");
  push(qs3, "20190211:2.0500:2.0700:3.0000:2.0200:234111:false");
  push(qs3, "20190210:2.0000:2.0700:3.0000:2.0200:234111:true");
  push(qs3, "20190208:2.0500:2.0700:3.0000:2.0200:234111:false");
  push(qs3, "20190207:2.0000:2.0700:3.0000:2.0200:234111:true");
  push(qs3, "20190206:2.0000:2.0700:3.0000:2.0200:234111:true");

  es_qs = quote_blend(qs3, qs1, qs2);
  es = tp_e1(es_qs);
  qs3 = tp_e2(es_qs);

  assert(eq(arr_get(qs3, 0),
    "20190215:-1.0000:-1.0000:-1.0000:-1.0000:-1:true"));
  ...
  assert(eq(arr_get(qs3, 6),
    "20190208:2.0000:2.0700:3.0000:2.0200:234111:true"));
  assert(eq(arr_get(qs3, 7),
    "20190207:2.0500:2.0700:3.0000:2.0200:234111:false"));
  assert(eq(arr_get(qs3, 8),
    "20190206:2.0000:2.0700:3.0000:2.0200:234111:true"));

  assert(arr_size(es) == 3);
  assert(str_eq(arr_get(es, 0), "20190215: Missing quote"));
  assert(str_eq(arr_get(es, 1), "20190213: Open < Min"));
  assert(str_eq(arr_get(es, 2), "20190209: Extra quote"));
