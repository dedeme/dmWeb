...
import * as profitsPg from  "../pgs/ktmarket/profitsPg.js";
import * as percentsPg from  "../pgs/ktmarket/percentsPg.js";
...
export  function process(wg, dbmenu, LcPath)  {sys.$params(arguments.length, 3);
  ...
  const lopts =sys.$checkNull( [
    ...
    menu.separator2(),
    menu.tlink("profits", II("Profits"), ["ktmarket"]),
    menu.separator(),
    menu.tlink("percents", II("Percentages"), ["ktmarket"])
  ]);
