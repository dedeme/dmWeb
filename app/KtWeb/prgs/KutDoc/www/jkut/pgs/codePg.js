...
const reserved =sys.$checkNull( "break catch continue default else false finally for if import " +
  "return switch trace true try while")
;
const lib =sys.$checkNull( "arr b64 bytes cryp dic file iter js math path regex str sys tcp " +
  "thread time")
;
